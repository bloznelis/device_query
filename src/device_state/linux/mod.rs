...
impl DeviceState {
    ...
    fn kernel_key_to_keycode(&self, kernel_code: u8) -> Option<Keycode> {
        match kernel_code as u16 {
            ...
            kernel_key::KEY_NUMLOCK => Some(Keycode::Numlock),
            kernel_key::KEY_SCROLL => Some(Keycode::Scroll),
            kernel_key::KEY_PRINT => Some(Keycode::Print),
            kernel_key::KEY_PAUSE => Some(Keycode::Pause),
